...
const navGroups = [
    ...
    },
    {
        ...
        items: [
            {
                name: 'Hacienda & Activo', href: '/hacienda', icon: (
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            {
                name: 'Estilo de Vida', href: '/retire', icon: (
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
        ...
        items: [
            {
                name: 'La Oportunidad', href: '/oportunidad', icon: (
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            {
                name: 'Modelo Económico', href: '/modelo-negocio', icon: (
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            {
                name: 'Estructura Legal', href: '/estructura', icon: (
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
        ...
        items: [
            {
                name: 'Transparencia', href: '/seguridad', icon: (
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            {
                name: 'Memorándum', href: '/memorandum', icon: (
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            {
                name: 'Gobernanza', href: '/gobernanza', icon: (
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
